...
; Route 20
	...
	db 35, STARYU, 0								; 10
	db 28, HORSEA, HORSEA, SEADRA, HORSEA, 0		; 11
	db 30, STARYU, STARMIE, 0						; 12
; Route 21
	db 33, SEADRA, TENTACRUEL, 0					; 13
	db 37, STARMIE, 0								; 14
	db 33, STARYU, WARTORTLE, 0						; 15
	db 32, POLIWHIRL, TENTACOOL, SEADRA, 0			; 16
