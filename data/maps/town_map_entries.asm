...
InternalMapEntries:
	...
	internal_map MT_SILVER_CAVE_1F,				 0,  7, MtSilverCaveName
	internal_map MT_SILVER_CAVE_2F,				 0,  7, MtSilverCaveName
	internal_map MT_SILVER_CAVE_3F,				 0,  7, MtSilverCaveName
	internal_map MT_SILVER_HIDDEN_FLOOR,		 0,  7, MtSilverCaveName
